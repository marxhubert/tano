...
#### [MODIFY] [note_card.dart](./lib/shared/widgets/note_card.dart)
...
#### [NEW] [trash_page.dart](./lib/features/trash/trash_page.dart)
...
#### [NEW] [trash_view_model.dart](./lib/features/trash/trash_view_model.dart)
- Handle loading deleted notes and the restore/purge logic.

#### [MODIFY] [settings_page.dart](./lib/features/settings/settings_page.dart)
...
#### [MODIFY] [sqlite_notes_repository.dart](./lib/core/repositories/sqlite_notes_repository.dart)
