...
metadata understates size. A deterministic mutation/fuzz smoke test and a 300-note
import/search exercise the path; full coverage-guided fuzzing and device-side memory
profiling remain before release.
