...
class AppText {
    ...
    static const Map<String, String> _en = <String, String>{
        ...
        'about_description': 'The main goal of Tano is to provide a simple tool that lets you write notes to keep your ideas, create to-do lists and organize your projects at the same place. Tano prioritizes ease of use over bells and whistles.',
        'close_button': 'CLOSE',
        'home': 'Home',
        'about': 'About',
        // Menu
    ...
    static const Map<String, String> _fr = <String, String>{
        ...
        'about_description': "TanoNote est un simple outil de prise de note qui pourra, je l'espère vivement, vous être utile pour sauvegarder vos idées.\nJe vous invite à me faire part de vos remarques et conseils pour me donner le plaisir de continuer à l'améliorer. Merci.",
        'close_button': 'FERMER',
        'home': 'Accueil',
        'about': 'À propos',
        // Menu
