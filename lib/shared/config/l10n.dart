...
class AppText {
  ...
  static const Map<String, String> _en = <String, String>{
    ...
    'single_item_selected': '{count} single item selected',
    'items_selected': '{count}/{total} items selected',
    'all_items_selected': 'All {count} items are selected',
  ...
  static const Map<String, String> _fr = <String, String>{
    ...
    'single_item_selected': '{count} seul élément sélectionné',
    'items_selected': '{count}/{total} éléments sélectionnés',
    'all_items_selected': 'Tous les {count} éléments sont sélectionnés',
  ...
  static const Map<String, String> _mg = <String, String>{
    ...
    'no_item_selected': 'Tsy misy singa voafantina',
    ...
    'single_item_selected': 'Singa {count} voafantina',
    'items_selected': 'Singa {count}/{total} voafantina',
    'all_items_selected': 'Voafantina daholo ny singa {count}',
