...
class SearchViewModel extends ChangeNotifier {
    ...
    Future<void> applyNoteAction({required Note original, required NoteAction action}) async {
    ...
    void _runSearch() {
        ...
        for (final Note note in _allNotes) {
            final bool inTitle = note.title != null && note.title!.contains(RegExp(keyword, caseSensitive: false));
            final bool inContent = note.content != null && note.content!.contains(RegExp(keyword, caseSensitive: false));
